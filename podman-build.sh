...
podman build --platform=linux/amd64 -t ghcr.io/jenzoga/pterodactyl-yolks:java-21-graalvm-ee -f java-21-graalvm-ee.Dockerfile .
podman build --platform=linux/amd64 -t ghcr.io/jenzoga/pterodactyl-yolks:java-8-graalvm-ee -f java-8-graalvm-ee.Dockerfile .
podman build --platform=linux/amd64 -t ghcr.io/jenzoga/pterodactyl-yolks:java-22-graalvm-ee -f java-22-graalvm-ee.Dockerfile .
